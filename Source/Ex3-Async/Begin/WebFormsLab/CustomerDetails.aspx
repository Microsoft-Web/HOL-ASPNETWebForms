...
<h3>Customer Details</h3>
     ...
     <EditItemTemplate>
        <fieldset>
            <ul>
                ...
                <li><asp:TextBox runat="server" ID="firstName" Text='<%#: BindItem.FirstName %>' /></li>
            </ul>
            <ul>
                <li><asp:Label runat="server" AssociatedControlID="lastName">Last Name: </asp:Label></li>
                <li><asp:TextBox runat="server" ID="lastName" Text='<%#: BindItem.LastName %>' /></li>
            </ul>
            <ul>
    ...
    <a href="Customers.aspx" >Return to Customers Page</a>
</asp:Content>
